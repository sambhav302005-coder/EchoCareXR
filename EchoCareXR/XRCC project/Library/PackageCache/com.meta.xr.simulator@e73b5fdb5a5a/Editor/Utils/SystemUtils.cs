...
namespace Meta.XR.Simulator.Editor
{
    internal class SystemUtils
    {
        ...
        internal virtual string GetDownloadURL(string installedVersion = null)
        {

            var url = $"https://www.facebook.com/horizon_devcenter_download?app_id={XRSimConstants.AppId}&sdk_version={XRSimConstants.PackageVersion}";
            if (!string.IsNullOrEmpty(installedVersion))
            {
                url += $"&installed_version={installedVersion}";
            }
